...
public class BetInfoTest4 extends BetInformation {

    static Component betOption = DealerTable.BettingOption.Tie;
    ...
    public static void verify() {
        ...
        double expectedWinLoss = totalBet * 8;
        ...
        VerificationHandler.verifyIfDisplayed(BetDetails.BettingChip.Tie, 5);
